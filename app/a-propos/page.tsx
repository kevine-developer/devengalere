    ...
    <div className="min-h-screen">
      ...
      <section className="relative overflow-hidden px-4 py-20 sm:px-6 sm:py-32 lg:px-8">
        ...
        <div className="relative mx-auto max-w-4xl">
          <div className="flex flex-col items-center text-center">
            ...
            <div className="relative mb-8">
              ...
              <div className="absolute -bottom-2 -right-2 flex h-10 w-10 items-center justify-center bg-lime">
                <span className="font-mono text-lg font-bold text-(--deg-black)">{">"}_</span>
              </div>
            </div>

            <span className="mb-4 font-mono text-xs uppercase tracking-widest text-lime">[À propos]</span>
          ...
          <div className="mt-12 flex justify-center gap-2">
            {[
              { icon: GithubIcon, href: "https://github.com/devengalere", label: "GitHub" },
              { icon: TwitterIcon, href: "https://twitter.com/devengalere", label: "X" },
              { icon: LinkedinIcon, href: "https://linkedin.com/in/devengalere", label: "LinkedIn" },
            ].map((social) => (
              <a
                key={social.label}
                href={social.href}
      ...
      <section className="border-y border-(--deg-gray-light) stripes px-4 py-20 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-3xl">
          <div className="bg-(--deg-dark) border border-(--deg-gray-light) p-8 sm:p-12">
            <h2 className="mb-8 font-mono text-xs uppercase tracking-widest text-lime">{"// L'histoire"}</h2>
            <div className="space-y-6 font-mono text-sm text-(--deg-muted)">
              <p>
                <span className="text-(--deg-white)">DevEnGalère</span> est né d'un constat simple : on galère
                tous. Bugs mystérieux à 3h du mat', docs inexistantes, stack overflow de 2014 comme seule solution...
              </p>
              <p>
                Plutôt que de galérer seul dans mon coin, j'ai décidé de documenter tout ça. Les galères, les solutions,
                les découvertes. En format court, direct, sans bullshit.
              </p>
              <p>
                Aujourd'hui, DevEnGalère c'est une communauté de devs qui s'entraident, du contenu tech authentique, et
                la preuve que <span className="text-lime">galérer, c'est aussi progresser.</span>
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="px-4 py-20 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-5xl">
          <h2 className="mb-12 text-center font-mono text-xs uppercase tracking-widest text-lime">{"[Les valeurs]"}</h2>
          <div className="grid gap-0 border border-(--deg-gray-light) md:grid-cols-3">
            {[
              {
                num: "01",
                title: "Authenticité",
                description: "Pas de façade. Les galères font partie du métier, autant les assumer.",
              },
              {
                num: "02",
                title: "Pragmatisme",
                description: "Des solutions qui marchent en vrai, pas des théories abstraites.",
              },
              {
                num: "03",
                title: "Partage",
                description: "Ce qu'on apprend seul, on le partage à tous. C'est ça, la communauté.",
              },
            ].map((value, index) => (
              <div
                key={value.title}
                className={`relative p-8 transition-colors hover:bg-(--deg-dark) ${index < 2 ? "border-r border-(--deg-gray-light)" : ""}`}
              >
                ...
                <p className="font-mono text-xs text-(--deg-muted)">{value.description}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="border-t border-(--deg-gray-light) px-4 py-20 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <button className="btn-brutal px-8 py-4 text-sm">Me contacter →</button>
        </div>
      </section>
    </div>
  )
