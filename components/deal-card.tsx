    ...
    <div className="card-cut group relative overflow-hidden cursor-default">
      <div className="p-6">
        ...
        <div className="mb-4 flex items-start justify-between">
          ...
          <div className="flex items-center gap-2">
            <div className="flex flex-col gap-2">
              {deal.recommended && (
                <div className="flex items-center gap-1 border bg-(--deg-dark) px-2 py-1">
          ...
          <div className="mb-3 flex items-center gap-3">
            ...
            {deal.userCount && (
              <div className="flex items-center gap-1">
                ...
                <span className="font-mono text-xs text-(--deg-muted)">
                  {deal.userCount} utilisateurs
                </span>
              </div>
            )}
          </div>
        ...
        <div className="mb-2">
          ...
          <h3 className="mt-1 text-base font-bold uppercase leading-tight tracking-tight">
            {deal.title}
          </h3>
        </div>
        ...
        {deal.discount && (
          <div className="mb-4 inline-flex items-center border-2 border-lime bg-lime/10 px-3 py-2">
            <span className="text-base font-bold ">{deal.discount}</span>
          ...
          <div className="mb-4 border border-(--deg-gray-light) bg-(--deg-gray) p-3">
            <div className="flex items-center justify-between gap-3">
              ...
              <button
                ...
                className="shrink-0 cursor-pointer border  bg-transparent px-3 py-2 text-lime transition-all hover:bg-lime hover:text-(--deg-black) active:scale-95"
        ...
        <button
          onClick={handleVisit}
          className="mb-3 flex w-full cursor-pointer items-center justify-center gap-2 border border-lime bg-transparent py-3 font-mono text-sm uppercase tracking-wider  transition-all hover:bg-lime  active:scale-[0.98]"
        >
          {deal.type === "tutorial" || deal.type === "formation"
            ? "Voir le contenu"
            : "Profiter de l'offre"}
