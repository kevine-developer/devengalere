...
export function HeroSection() {
  return (
    <section className="relative overflow-hidden px-4 py-20 sm:px-6 sm:py-32 lg:px-8" aria-labelledby="hero-heading">
      {/* Grid background */}
      ...
      <div className="relative mx-auto max-w-5xl">
        ...
        >
          ...
          <span className="relative inline-block">
            ...
            <svg className="absolute -bottom-2 left-0 w-full" viewBox="0 0 300 12" fill="none" aria-hidden="true">
              <path d="M0 6C50 0 100 12 150 6C200 0 250 12 300 6" stroke="#c8ff00" strokeWidth="4" />
            </svg>
          </span>
          ,
          <br />
        ...
        <p className="mb-10 max-w-2xl font-mono text-lg text-(--deg-muted) text-pretty sm:text-xl">
          <span aria-hidden="true">{">"} </span>Projets concrets, articles sans bullshit,
          <br />
          <span aria-hidden="true">{">"} </span>et vidéos pour les devs qui veulent avancer.
          <span className="cursor-blink" aria-hidden="true"></span>
        </p>

        <div className="flex flex-col gap-4 sm:flex-row">
          <a href="/projets" className="btn-brutal inline-flex items-center justify-center gap-2 px-8 py-4 text-sm">
            Voir les projets
            <ArrowRight className="h-4 w-4" aria-hidden="true" />
          </a>
          <a href="/a-propos" className="btn-outline-brutal inline-flex items-center justify-center px-8 py-4 text-sm">
            En savoir plus
          </a>
        </div>
        ...
        >
          {[
            ...
            <div
              key={stat.label}
              role="listitem"
              className={`p-6 text-center ${index < 3 ? "border-r border-(--deg-gray-light)" : ""} ${index < 2 ? "border-b border-(--deg-gray-light) sm:border-b-0" : ""}`}
            >
              <div className="text-3xl font-bold text-lime sm:text-4xl">{stat.value}</div>
